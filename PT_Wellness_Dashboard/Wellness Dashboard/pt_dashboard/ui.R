    ...
    mainPanel(
      tabsetPanel(
        ...
        tabPanel('Patient Overview', 
                 wellPanel(fluidRow(
                   fluidRow(
                     column(width = 4, h2('SANE'), textOutput('txtSANE')),
                     column(width = 4, h2('Performance'), verbatimTextOutput('txtPerformance')),
                     column(width = 4, h2('Wellness'), verbatimTextOutput('txtWellness'))
                   ),
                   fluidRow(
                     column(width = 4, h2('Frequency'), verbatimTextOutput('txtFrequency')),
                     column(width = 4, h2('Severity'), verbatimTextOutput('txtSeverity')),
                     column(width = 4, h2('Sleep'), verbatimTextOutput('txtSleep'))
                   )
                 ),
